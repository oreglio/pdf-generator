...
class SplitRenderingTests(unittest.TestCase):
    ...
    def test_previews_gain_a_page_for_every_optional_section(self):
        ...
        self.assertEqual(preview_kinds(build_manifest(base), 'undated'),
                         ('home', 'meeting', 'task-list', 'task-notes'))
        ...
        output = io.BytesIO()
        self.assertEqual(generate_samples(with_projects, output), 7)
        ...
        self.assertEqual(preview_kinds(build_manifest(plain), 'dated'),
                         ('home', 'calendar', 'weekly', 'meeting', 'task-list', 'task-notes'))
        ...
        self.assertEqual(preview_kinds(build_manifest(rich), 'dated'),
                         ('home', 'calendar', 'month-plan', 'week-overview', 'weekly',
                          'week-review', 'meeting', 'task-list', 'task-notes',
                          'projects-index', 'project', 'project-notes'))
        output = io.BytesIO()
        self.assertEqual(generate_dated_samples(rich, output), 12)
        reader = PdfReader(output)
